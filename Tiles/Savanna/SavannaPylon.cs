...
/// </br>
/// </summary>
public class SavannaPylon : ModPylon
{
	...
	public override void SetStaticDefaults()
	{
		...
		TEModdedPylon moddedPylon = ModContent.GetInstance<SavannaPylonTileEntity>();
	...
	public override void MouseOver(int i, int j)
	{
		...
		Main.LocalPlayer.cursorItemIconID = ModContent.ItemType<Items.Placeable.Tile.SavannaPylon>();
	}
	...
	public override void KillMultiTile(int i, int j, int frameX, int frameY)
	{
		...
		ModContent.GetInstance<SavannaPylonTileEntity>().Kill(i, j);
	}
	...
	public override void DrawMapIcon(ref MapOverlayDrawContext context, ref string mouseOverText, TeleportPylonInfo pylonInfo, bool isNearPylon, Color drawColor, float deselectedScale, float selectedScale)
	{
		...
		DefaultMapClickHandle(mouseOver, pylonInfo, ModContent.GetInstance<Items.Placeable.Tile.SavannaPylon>().DisplayName.Key, ref mouseOverText);
	}
}
