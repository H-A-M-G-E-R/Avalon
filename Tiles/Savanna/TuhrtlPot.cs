...
public class TuhrtlPot : ModTile
{
	public override void SetStaticDefaults()
	{
		...
		AddMapEntry(new Color(115, 106, 99), name);
	...
	public override void KillMultiTile(int i, int j, int frameX, int frameY)
	{
		...
		Gore.NewGore(WorldGen.GetItemSource_FromTileBreak(i, j), new Vector2(i * 16, j * 16), default, ModContent.GoreType<Gores.TuhrtlPotGore1>());
		Gore.NewGore(WorldGen.GetItemSource_FromTileBreak(i, j), new Vector2(i * 16, j * 16), default, ModContent.GoreType<Gores.TuhrtlPotGore2>());
