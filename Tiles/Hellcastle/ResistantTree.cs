...
namespace Avalon.Tiles.Hellcastle
{
    public class ResistantTree : ModTree
	{
        ...
        public override void SetStaticDefaults()
        {
			...
			texture = ModContent.Request<Texture2D>("Avalon/Tiles/Hellcastle/ResistantTree");
			branchesTexture = ModContent.Request<Texture2D>("Avalon/Tiles/Hellcastle/ResistantTree_Branches");
			topsTexture = ModContent.Request<Texture2D>("Avalon/Tiles/Hellcastle/ResistantTree_Tops");
		}
