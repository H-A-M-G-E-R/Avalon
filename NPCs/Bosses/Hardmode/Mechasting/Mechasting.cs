...
namespace Avalon.NPCs.Bosses.Hardmode.Mechasting;
        ...
        if (!SecondPhase)
        {
            ...
            if (NPC.ai[3] == 1)
            {
                ...
                if (NPC.ai[0] >= 90)
                {
                    ...
                    int damage = 30;
                    int type = ModContent.ProjectileType<Mechastinger>();
            ...
            if (NPC.ai[3] == 3)
            {
                ...
                if (NPC.ai[1] >= 240 && NPC.ai[1] <= 300)
                {
                    ...
                    if (NPC.ai[1] % 60 == 0)
                    {
                        ...
                        {
                            // above the boss
                            p = Projectile.NewProjectile(NPC.GetSource_FromAI(), NPC.Center.X, NPC.Center.Y, (float)(Math.Cos(rotation + f) * speed * -1), (float)(Math.Sin(rotation + f) * speed * -1), ModContent.ProjectileType<ElectricBolt>(), 25, 0f, NPC.target);
