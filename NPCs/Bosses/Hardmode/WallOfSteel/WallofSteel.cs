...
public class WallofSteel : ModNPC
{
	...
	public override string Texture => (GetType().Namespace + "." + "WallofSteelWall").Replace('.', '/');
	public override void Load()
	{
		wosTexture = ModContent.Request<Texture2D>((GetType().Namespace + "." + Name).Replace('.', '/'));
		mechaHungryChainTexture = ModContent.Request<Texture2D>((GetType().Namespace + "." + "MechaHungryChain").Replace('.', '/'));
	}
	...
	public override void SetStaticDefaults()
	{
		...
		{ // Influences how the NPC looks in the Bestiary
			CustomTexturePath = (GetType().Namespace + "." + "WallofSteelBestiary").Replace('.', '/'),
