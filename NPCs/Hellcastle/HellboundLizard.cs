...
public class HellboundLizard : CustomFighterAI
{
	...
	public override float MaxMoveSpeed => 3f;
	public override float Acceleration => 0.25f;
	public override float AirAcceleration => 0.15f;
	...
	public override void HitEffect(NPC.HitInfo hit)
	{
		for (int i = 0; i < 20; i++)
		{
			int num890 = Dust.NewDust(NPC.position, NPC.width, NPC.height, DustID.Torch, 0f, 0f, 0, default, 1f);
