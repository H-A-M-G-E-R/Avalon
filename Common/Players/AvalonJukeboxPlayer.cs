...
namespace Avalon.Common.Players
{
    internal class AvalonJukeboxPlayer : ModPlayer
    {
		...
		public static Dictionary<int, int> MusicLoader_ItemToMusic = (Dictionary<int, int>)typeof(MusicLoader).GetField("itemToMusic", BindingFlags.NonPublic | BindingFlags.Static).GetValue(null);
		public static Dictionary<int, int> MusicLoader_MusicToItem = (Dictionary<int, int>)typeof(MusicLoader).GetField("musicToItem", BindingFlags.NonPublic | BindingFlags.Static).GetValue(null);
