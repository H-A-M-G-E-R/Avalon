...
public class TourmalineGemcartBuff : ModBuff
{
    ...
    public override LocalizedText DisplayName => ModContent.GetInstance<TourmalineMinecart>().DisplayName;
    ...
    public override void SetStaticDefaults()
    {
		...
		BuffID.Sets.MountType[Type] = ModContent.MountType<TourmalineGemcart>();
