...
public class LostSoul : ModProjectile
{
	...
	public override void AI()
	{
		...
		Projectile.ai[1]++;
		if (Projectile.ai[1] is > 50 and < 90)
		{
			Projectile.velocity += Projectile.Center.DirectionTo(player.Center) * 0.5f;
		}
		if(Projectile.velocity.Length() < 8 && Projectile.ai[1] > 90)
		{
			Projectile.velocity *= 1.02f;
			Projectile.velocity.LengthClamp(8);
		}
		...
		if (Projectile.ai[1] > 100 && !Projectile.tileCollide && !Collision.SolidCollision(Projectile.position,Projectile.width,Projectile.height))
		{
