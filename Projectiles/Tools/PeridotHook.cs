...
public class PeridotHook : ModProjectile
{
	...
	public override void SetStaticDefaults()
    {
        ...
        chainTexture = ModContent.Request<Texture2D>("Avalon/Projectiles/Tools/PeridotHook_Chain");
    }
    ...
    public override bool PreDraw(Player player, ref Color lightColor)
    {
        ...
        var origin = new Vector2(chainTexture.Value.Width * 0.5f, chainTexture.Value.Height * 0.5f - 2);
